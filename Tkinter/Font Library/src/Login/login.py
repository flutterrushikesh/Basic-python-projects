...
class MainFrame():
    ...
    def logIn(self):
        ...
        # ====== Login Frame =========================
        self.lgn_frame = tk.Frame(self.main_frame, bg='#040405', width=990,
        height=650)
        ...
        self.side_image_label = tk.Label(self.lgn_frame, image=photo,
        bg='#040405')
        ...
        self.sign_in_image_label = tk.Label(self.lgn_frame, image=photo,
        bg='#040405')
        ...
        # ============ Sign In label=============================================
        self.sign_in_label = tk.Label(self.lgn_frame, text="Sign In",
        bg="#040405", fg="white",font=("yu gothic ui", 17, "bold"))
